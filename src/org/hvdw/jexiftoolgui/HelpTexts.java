...
public class HelpTexts {
    ...
    */
    ...
    public static final String GeotaggingHelp = "Geotagging adds GPS data to your images based on data from a GPS track log file."
            ...
            + "and a leading \"+\" or \"-\" may be added for positive or negative differences.<br><b>Note:</b> Do not use (double) quotes around the geosync time in jExifToolGUI. Simply use something like -25 or +1:20</p>"
