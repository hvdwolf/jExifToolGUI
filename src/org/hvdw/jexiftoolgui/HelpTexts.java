...
public class HelpTexts {
    ...
    */
    ...
    public static final String ExifAndXmpHelp = "<html><table width='900'><tr><td><p>This tab is used to add (a limited amount of) xmp data to your selected image(s).</p>"
            ...
            + "<li><b>Help</b>: This button opens this popup that you are currently reading.</li></ul></td></tr></table></html>";
    public static final String GeotaggingHelp = "<html><table width='900'><tr><td><p>Geotagging adds GPS data to your images based on data from a GPS track log file."
            ...
            + "are written to the image (if the corresponding information is available). It means that your camera needs to be set correctly with regard to the date/time of the location where you are.<br>"
            ...
            + "and a leading \"+\" or \"-\" may be added for positive or negative differences.<br>Note: Do not use (double) quotes around the geosync time in jExifToolGUI. Simply use something like -25 or +1:20</p>"
            + "<p>In jExifToolGUI you have 2 options:"
            ...
            + "Note that jExifToolGUI will write both the EXIF GPS tags as well as the XMP GPS tags.</td></tr></table></html>";
    public static final String YourCommandsHelp = "<html><table width='900'><tr><td>On this tab you can define your own parameters to \"send to\" exiftool. The parameters will be executed on the images you have selected on the left."
    ...
    public static final String CopyMetaDataHelp = "<html><table width='600'><tr><td>This function will copy all or selected metadata from the source image into the target image(s).<br><br>"
