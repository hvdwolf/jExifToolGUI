...
public class PreferencesDialog extends JDialog {
    ...
    public void showDialog() {
        ...
        String[] appLocales = {"System default - default", "de_DE - Deutsch", "en_US - English", "es_ES - Español", "in_ID - Bahasa Indonesia", "iw_HE - עִברִית", "nb_NO - Norsk (bokmål)", "nl_NL - Nederlands", "ru_RU - Pусский", "zh_CN - 简体中文"};
