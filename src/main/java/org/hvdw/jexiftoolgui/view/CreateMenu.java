...
public class CreateMenu {
    ...
    public void CreateMenuBar(JFrame frame, JPanel rootPanel, JSplitPane splitPanel, JMenuBar menuBar, JMenu myMenu, JLabel OutputLabel, JProgressBar progressBar, JComboBox UserCombiscomboBox) {


        MenuActionListener mal = new MenuActionListener(frame, rootPanel, splitPanel, menuBar, OutputLabel, progressBar, UserCombiscomboBox);
