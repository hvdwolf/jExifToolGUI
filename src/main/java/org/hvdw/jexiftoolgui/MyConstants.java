...
public static final String[] RAW_IMAGES = {"3fr","acr","ai","ait","arw","dib","btf","cos","cr2","crw","ciff","cs1","dcm","dc3","dic","dicm","dcp","dcr","djvu","djv","dng","eip","erf","exif","exr","fff","fpx","hdp","wdp","hdr","icc","icm","idml","iiq","ind","indd","indt","inx","itc","j2c","jpc","jp2","jpf","j2k","jpm","jpx","k25","kdc","mef","mie","miff","mif","mos","mpo","mrw","mxf","nef","nrw","orf","pcd","pdf","pef","pgf","pict","pct","pmp","jng","mng","ppm","pbm","pgm","psp","pspimage","qtif","qti","qif","raf","raw","rw2","rwl","rwz","sr2","srf","srw","svg","thm","webp","x3f","xcf","xmp"};
    ...
    public static final String[] JAVA_SUP_EXTENSIONS = {"bmp","gif,","jpg", "jpeg", "png", "tif", "tiff", "ppm", "pbm", "pgm"};
    //public static final String[] JAVA8_IMG_EXTENSIONS = {"bmp","gif,","jpg", "jpeg", "png", "tif", "tiff", "ppm", "pbm", "pgm"};
    //public static final String[] JAVA11_IMG_EXTENSIONS = {"bmp","gif,","jpg", "jpeg", "png", "tif", "tiff","ppm","pbm","pgm"};
