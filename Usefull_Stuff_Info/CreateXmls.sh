...
#$exiftoolpath/exiftool -listx -IFD0:all > "$DIR"/IFD0.xml
#$exiftoolpath/exiftool -listx -IFD1:all > "$DIR"/IFD1.xml
#$exiftoolpath/exiftool -listx -IFD2:all > "$DIR"/IFD2.xml
#$exiftoolpath/exiftool -listx -IFD3:all > "$DIR"/IFD3.xml
#$exiftoolpath/exiftool -listx -InteropIFD:all > "$DIR"/InteropIFD.xml
...
#$exiftoolpath/exiftool -listx -KodakMeta:all > "$DIR"/KodakMeta.xml
...
#$exiftoolpath/exiftool -listx -RicohRMETA:all > "$DIR"/RicohRMETA.xml
...
#$exiftoolpath/exiftool -listx -XMP-xmpRightsApple:all > "$DIR"/XMP-xmpRightsApple.xml
...
# Now delete the ones that are actually not correctly produced
cd "$DIR" 
grep -l exiftool *.xml | xargs rm
